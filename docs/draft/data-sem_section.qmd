...
\tikz{
   ...
   % X->X%
    ...
    % \node (y1s) at (0.6,-1) {$Y_1$};
    %\node (y2s) at (3,-1) {$Y_2$};
    %\node (y3s) at (5.4,-1) {$Y_3$};
    %\node (x1s) at (0.6,-3) {$X_1$};
    %\node (x2s) at (3,-3) {$X_2$};
    %\node (x3s) at (5.4,-3) {$X_3$};
    ...
    %\path (x1s) edge [bend right=70, arrows = <->, dashed] (y1s);
    %\path (x2s) edge [bend right=70, arrows = <->, dashed] (y2s);
    %\path (x3s) edge [bend right=70, arrows = <->, dashed] (y3s);
  }
```
