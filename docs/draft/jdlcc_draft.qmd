...
<!-- CCL: Disorder and fear annual review (not mine): 10.1146/annurev-criminol-011518-024638 -->
<!-- TO: Done -->
...
<!-- CCL: Would be nice to cite my friend Bob Crutchfield on complexity of the employment-crime link: 10.18574/nyu/9780814717073.001.0001 -->
<!-- TO: Done above and here -->
...
\tikz{
    ...
    \node (x2) at (2,0) {$X_2$};
    \node (x3) at (4,0) {$X_3$};
    \node (ey2) at (2.5,3) {$\epsilon_{2}$};
    \node (ex2) at (2.5,-1) {$\zeta_{2}$};
    \node (ey3) at (4.5,3) {$\epsilon_{3}$};
    \node (ex3) at (4.5,-1) {$\zeta_{3}$};
    \path (x1) edge (x2);
    \path (x2) edge (x3);
    \path (x1) edge (y2);
    \path (x2) edge (y3);
    ...
    \path (y1) edge (x2);
    \path (y2) edge (x3);
    \path (x1) edge [bend left=60, arrows = <->] (y1);
    \path (ex2) edge [bend right=30, arrows = <->] (ey2);
    \path (ex3) edge [bend right=30, arrows = <->] (ey3);
    \path (ex2) edge (x2);
    \path (ex3) edge (x3);
    \path (ey2) edge (y2);
    \path (ey3) edge (y3);
    ...
    \node (ey1b) at (6.5,3) {$\epsilon_{1}$};
    \node (ey2b) at (8.5,3) {$\epsilon_{2}$};
    \node (ex2b) at (8.5,-1) {$\zeta_{2}$};
    \node (ey3b) at (10.5,3) {$\epsilon_{3}$};
    \node (ex3b) at (10.5,-1) {$\zeta_{3}$};
