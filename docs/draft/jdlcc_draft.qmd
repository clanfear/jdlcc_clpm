...
> CCL: Need to slot these in somewhere. Perhaps up a bit to point out contemporaneous vs. not.
...
One of the biggest advantages of drawing on longitudinal data is the ability to focus exclusively on within-unit variation (i.e., change over time) and control away any stable differences between units. 
