...
<!--CCL: -->
* The role of time
  * There are no simultaneous effects; when researchers posit them, it is for convenience (Strotz & Wold 1960).

* Estimands
  * The estimand is the quantitative definition of the causal effect of interest, e.g., a difference in potential outcomes.
  * Estimands do not exist out in the world; they are chosen by researchers.
  * There is no "true causal timing" because causal timing is one of a number of choices a researcher makes when defining their estimand of interest. To illustrate, consider what is the true causal timing of drinking a pint of beer on your judgment? Consider this effect at 20 seconds, 20 minutes, and 20 hours. What about the effect on your thirst or your headache? Strong theories are specific about timing in causal processes and inform what sort of causal timings are of interest. Researchers need to make an argument that the estimand they are studying, including the timing of the effect, is useful and can be studied with the data they have. While we focus here on longitudinal data, this applies just as much to cross-sectional data, except there researchers have less control over what timings they may examine. Even provided otherwise identical estimands, discrepant results between studies may be due to different choices of causal timing (Gollob & Reichardt 1987; see also Vaisey & Miles 2017).


Ref to Lundberg et al. (2021) but avoid getting into too much detail here

<!-- CCL: Old lit on  e.g., GOllob & Reichardt 1987; Strotz & Wold 1960; and waaay on back -->
